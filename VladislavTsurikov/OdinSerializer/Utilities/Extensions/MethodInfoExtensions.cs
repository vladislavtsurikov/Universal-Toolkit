...
namespace OdinSerializer.Utilities
{
    ...
    public static class MethodInfoExtensions
    {
        ...
        {
            ParameterInfo[] pinfos = method.IsExtensionMethod()
        ...
        /// </summary>
        public static string GetFullName(this MethodBase method) => GetFullName(method, "[ext] ");
        ...
        /// </returns>
        public static bool IsAliasMethod(this MethodInfo methodInfo) => methodInfo is MemberAliasMethodInfo;
        ...
        {
            var aliasMethodInfo = methodInfo as MemberAliasMethodInfo;
