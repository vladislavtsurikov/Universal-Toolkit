...
namespace OdinSerializer.Utilities.Editor
{
    ...
    {
        private static readonly MethodInfo getPropertyIntMethod;
        private static readonly MethodInfo getScriptingBackendMethod;
        private static readonly MethodInfo getApiCompatibilityLevelMethod;
        private static readonly MethodInfo apiCompatibilityLevelProperty;
        ...
        static AssemblyImportSettingsUtilities()
        {
            ...
            getPropertyIntMethod = typeof(PlayerSettings).GetMethod("GetPropertyInt", Flags.StaticPublic, null,
                new[] { typeof(string), typeof(BuildTargetGroup) }, null);
            ...
            getApiCompatibilityLevelMethod = typeof(PlayerSettings).GetMethod("GetApiCompatibilityLevel",
                Flags.StaticPublic, null, new[] { typeof(BuildTargetGroup) }, null);
            PropertyInfo apiLevelProperty =
                typeof(PlayerSettings).GetProperty("apiCompatibilityLevel", Flags.StaticPublic);
            ...
            JITPlatforms = new ImmutableList<BuildTarget>(Platforms
                .Where(i => i.ToString()
                    .StartsWith(
                        "StandaloneOSX")) // Unity 2017.3 replaced StandaloneOSXIntel, StandaloneOSXIntel64 and StandaloneOSXUniversal with StandaloneOSX.
                .Append(new[]
                {
            ...
            // All scripting backends that support JIT.
            JITScriptingBackends = new ImmutableList<ScriptingImplementation>(new[] { ScriptingImplementation.Mono2x });

            // Names of all api levels that support JIT.
            var jitApiNames = new[]
            {
                "NET_2_0", "NET_2_0_Subset", "NET_4_6", "NET_Web", // TODO: Does NET_Web support JIT stuff?
        ...
        public static void SetAssemblyImportSettings(BuildTarget platform, string assemblyFilePath,
            ...
            bool includeInEditor)
        {
            ...
            var updateImportSettings =
                importer
                    .GetCompatibleWithAnyPlatform() // If the 'any platform' flag is true, then reapply settings no matter what to ensure that everything is correct.
        ...
        public static ScriptingImplementation GetCurrentScriptingBackend()
        {
            ...
            {
                return (ScriptingImplementation)getPropertyIntMethod.Invoke(null,
                    new object[] { "ScriptingBackend", buildGroup });
            }
        ...
        public static bool PlatformSupportsJIT(BuildTarget platform) => JITPlatforms.Contains(platform);
        ...
        public static bool ScriptingBackendSupportsJIT(ScriptingImplementation backend) =>
            JITScriptingBackends.Contains(backend);
        ...
        public static bool ApiCompatibilityLevelSupportsJIT(ApiCompatibilityLevel apiLevel) =>
            JITApiCompatibilityLevels.Contains(apiLevel);
        ...
        public static bool IsJITSupported(BuildTarget platform, ScriptingImplementation backend,
            ApiCompatibilityLevel apiLevel) =>
            PlatformSupportsJIT(platform) && ScriptingBackendSupportsJIT(backend) &&
            ApiCompatibilityLevelSupportsJIT(apiLevel);
    }
}
