...
namespace OdinSerializer.Utilities
{
    ...
    public sealed class MemberAliasFieldInfo : FieldInfo
    {
        ...
        {
            AliasedField = field;
            Name = string.Concat(namePrefix, FAKE_NAME_SEPARATOR_STRING, AliasedField.Name);
        }
        ...
        {
            AliasedField = field;
            Name = string.Concat(namePrefix, separatorString, AliasedField.Name);
        }
        ...
        public override object[] GetCustomAttributes(Type attributeType, bool inherit) =>
            AliasedField.GetCustomAttributes(attributeType, inherit);
        ...
        public override bool IsDefined(Type attributeType, bool inherit) =>
            AliasedField.IsDefined(attributeType, inherit);
        ...
        /// </param>
        /// <param name="binder">
        ///     A set of properties that enables the binding, coercion of argument types, and invocation of
        ///     members through reflection. If <paramref name="binder" /> is null, then Binder.DefaultBinding is used.
        /// </param>
