...
namespace OdinSerializer.Utilities
{
    ...
    public sealed class MemberAliasMethodInfo : MethodInfo
    {
        ...
        public MemberAliasMethodInfo(MethodInfo method, string namePrefix)
        {
            ...
            Name = string.Concat(namePrefix, FAKE_NAME_SEPARATOR_STRING, AliasedMethod.Name);
        }
        ...
        {
            AliasedMethod = method;
            Name = string.Concat(namePrefix, separatorString, AliasedMethod.Name);
        }
        ...
        /// <summary>
        ///     When overridden in a derived class, returns the MethodInfo object for the method on the direct or indirect base
        ///     class in which the method represented by this instance was first declared.
        /// </summary>
        /// <returns>
        ...
        ///     <paramref name="attributeType" /> have been applied.
        /// </returns>
        public override object[] GetCustomAttributes(Type attributeType, bool inherit) =>
            AliasedMethod.GetCustomAttributes(attributeType, inherit);
        ...
        public override MethodImplAttributes GetMethodImplementationFlags() =>
            AliasedMethod.GetMethodImplementationFlags();

        /// <summary>
        ///     When overridden in a derived class, gets the parameters of the specified method or constructor.
        /// </summary>
        /// <returns>
        ///     An array of type ParameterInfo containing information that matches the signature of the method (or constructor)
        ///     reflected by this MethodBase instance.
        /// </returns>
        ...
        ///     ignored. If a constructor is static, this argument must be null or an instance of the class that defines the
        ///     constructor.
        /// </param>
        /// <param name="invokeAttr">
        ///     A bitmask that is a combination of 0 or more bit flags from
        ///     <see cref="T:System.Reflection.BindingFlags" />. If <paramref name="binder" /> is null, this parameter is assigned
        ///     the value <see cref="F:System.Reflection.BindingFlags.Default" />; thus, whatever you pass in is ignored.
        /// </param>
        /// <param name="binder">
        ///     An object that enables the binding, coercion of argument types, invocation of members, and
        ///     retrieval of MemberInfo objects via reflection. If <paramref name="binder" /> is null, the default binder is used.
        /// </param>
        /// <param name="parameters">
        ///     An argument list for the invoked method or constructor. This is an array of objects with the
        ///     same number, order, and type as the parameters of the method or constructor to be invoked. If there are no
        ///     parameters, this should be null.If the method or constructor represented by this instance takes a ByRef parameter,
        ///     there is no special attribute required for that parameter in order to invoke the method or constructor using this
        ///     function. Any object in this array that is not explicitly initialized with a value will contain the default value
        ///     for that object type. For reference-type elements, this value is null. For value-type elements, this value is 0,
        ...
        /// </param>
        /// <returns>
        ///     An Object containing the return value of the invoked method, or null in the case of a constructor, or null if the
        ///     method's return type is void. Before calling the method or constructor, Invoke checks to see if the user has access
        ///     permission and verifies that the parameters are valid.CautionElements of the <paramref name="parameters" /> array
        ///     that represent parameters declared with the ref or out keyword may also be modified.
        /// </returns>
        public override object Invoke(object obj, BindingFlags invokeAttr, Binder binder, object[] parameters,
            CultureInfo culture) =>
            AliasedMethod.Invoke(obj, invokeAttr, binder, parameters, culture);
        ...
        public override bool IsDefined(Type attributeType, bool inherit) =>
            AliasedMethod.IsDefined(attributeType, inherit);
    }
}
