...
namespace OdinSerializer.Utilities
{
    ...
    public sealed class MemberAliasPropertyInfo : PropertyInfo
    {
        ...
        public MemberAliasPropertyInfo(PropertyInfo prop, string namePrefix)
        {
            ...
            Name = string.Concat(namePrefix, FakeNameSeparatorString, AliasedProperty.Name);
        }
        ...
        {
            AliasedProperty = prop;
            Name = string.Concat(namePrefix, separatorString, AliasedProperty.Name);
        }
        ...
        public override object[] GetCustomAttributes(Type attributeType, bool inherit) =>
            AliasedProperty.GetCustomAttributes(attributeType, inherit);
        ...
        public override bool IsDefined(Type attributeType, bool inherit) =>
            AliasedProperty.IsDefined(attributeType, inherit);

        /// <summary>
        ///     Returns an array whose elements reflect the public and, if specified, non-public get, set, and other accessors of
        ///     the property reflected by the current instance.
        /// </summary>
        /// <param name="nonPublic">
        ///     Indicates whether non-public methods should be returned in the MethodInfo array. true if
        ///     non-public methods are to be included; otherwise, false.
        /// </param>
        /// <returns>
        ///     An array of <see cref="T:System.Reflection.MethodInfo" /> objects whose elements reflect the get, set, and other
        ///     accessors of the property reflected by the current instance. If <paramref name="nonPublic" /> is true, this array
        ///     contains public and non-public get, set, and other accessors. If <paramref name="nonPublic" /> is false, this array
        ///     contains only public get, set, and other accessors. If no accessors with the specified visibility are found, this
        ...
        /// </param>
        /// <returns>
        ///     A MethodInfo object representing the get accessor for this property, if <paramref name="nonPublic" /> is true.
        ///     Returns null if <paramref name="nonPublic" /> is false and the get accessor is non-public, or if
        ///     <paramref name="nonPublic" /> is true but no get accessors exist.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        ///     Value Condition A <see cref="T:System.Reflection.MethodInfo" /> object representing the Set method for this
        ///     property. The set accessor is public.-or- <paramref name="nonPublic" /> is true and the set accessor is non-public.
        ///     null<paramref name="nonPublic" /> is true, but the property is read-only.-or- <paramref name="nonPublic" /> is
        ///     false and the set accessor is non-public.-or- There is no set accessor.
        /// </returns>
        ...
        public override object GetValue(object obj, BindingFlags invokeAttr, Binder binder, object[] index,
            CultureInfo culture) =>
            AliasedProperty.GetValue(obj, invokeAttr, binder, index, culture);
