...
namespace OdinSerializer
{
    ...
    ///     <para />
    ///     NOTE that if you are implementing a custom formatter and registering it using the
    ///     <see cref="CustomFormatterAttribute" />, it is not enough to implement <see cref="IFormatter" /> - you have to
    ///     implement <see cref="IFormatter{T}" />.
    /// </summary>
