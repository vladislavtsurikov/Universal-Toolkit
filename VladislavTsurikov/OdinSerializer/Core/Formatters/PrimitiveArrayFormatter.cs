...
namespace OdinSerializer
{
    ...
    /// </summary>
    /// <typeparam name="T">
    ///     The element type of the formatted array. This type must be an eligible primitive array type, as
    ///     determined by <see cref="FormatterUtilities.IsPrimitiveArrayType(System.Type)" />.
    /// </typeparam>
    ...
    public sealed class PrimitiveArrayFormatter<T> : MinimalBaseFormatter<T[]> where T : struct
    {
        ...
        protected override void Write(ref T[] value, IDataWriter writer) => writer.WritePrimitiveArray(value);
    }
    ...
    public sealed class WeakPrimitiveArrayFormatter : WeakMinimalBaseFormatter
    {
        ...
        private static readonly Dictionary<Type, PrimitiveArrayType> PrimitiveTypes = new(FastTypeComparer.Instance)
        {
