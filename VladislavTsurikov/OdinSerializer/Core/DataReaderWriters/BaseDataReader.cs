...
namespace OdinSerializer
{
    ...
    public abstract class BaseDataReader : BaseDataReaderWriter, IDataReader
    {
                ...
                try
                {
                    if (type != null)
                    {
                        ...
                        if (FormatterUtilities.IsPrimitiveType(type))
                        {
                            ...
                            var value = serializer.ReadValueWeak(this);
                        ...
                        else
                        {
                            IFormatter formatter =
                                FormatterLocator.GetFormatter(type, Context.Config.SerializationPolicy);
                            var value = formatter.Deserialize(this);
            ...
            else if (peekedEntry == EntryType.StartOfArray)
            {
                ...
                while (true)
                {
                    ...
                    else
                    {
                     ...
                     peekedEntry != EntryType.EndOfNode) // We can't skip end of arrays and end of nodes
            {
        ...
        /// </summary>
        public virtual void PrepareNewSerializationSession() => ClearNodes();
