...
namespace OdinSerializer
{
    ...
    ///     <see cref="IDataReader" /> class.
    ///     <para />
    ///     If you implement this interface, it is VERY IMPORTANT that you implement each method to the *exact* specifications
    ///     the documentation specifies.
    ///     <para />
    ///     It is strongly recommended to inherit from the <see cref="BaseDataWriter" /> class if you wish to implement a new
    ///     data writer.
    /// </summary>
    ...
    public interface IDataWriter : IDisposable
    {
        ...
        /// <summary>
        ///     Gets a dump of the data currently written by the writer. The format of this dump varies, but should be useful for
        ///     debugging purposes.
        /// </summary>
        string GetDataDump();
