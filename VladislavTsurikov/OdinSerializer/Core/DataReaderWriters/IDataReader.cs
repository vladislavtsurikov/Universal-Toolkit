...
{
    /// <summary>
    ///     Provides a set of methods for reading data stored in a format written by a corresponding <see cref="IDataWriter" />
    ///     class.
    ///     <para />
    ///     If you implement this interface, it is VERY IMPORTANT that you implement each method to the *exact* specifications
    ///     the documentation specifies.
    ///     <para />
    ///     It is strongly recommended to inherit from the <see cref="BaseDataReader" /> class if you wish to implement a new
    ///     data reader.
    /// </summary>
    ...
    public interface IDataReader : IDisposable
    {
        ...
        /// </value>
        [Obsolete(
            "Data readers and writers don't necessarily have streams any longer, so this API has been made obsolete. Using this property may result in NotSupportedExceptions being thrown.",
            false)]
        ...
        /// <summary>
        ///     Gets a dump of the data being read by the writer. The format of this dump varies, but should be useful for
        ///     debugging purposes.
        /// </summary>
        string GetDataDump();
        ...
        /// <summary>
        ///     Skips the next entry value, unless it is an <see cref="EntryType.EndOfNode" /> or an
        ///     <see cref="EntryType.EndOfArray" />. If the next entry value is an <see cref="EntryType.StartOfNode" /> or an
        ///     <see cref="EntryType.StartOfArray" />, all of its contents will be processed, deserialized and registered in the
        ///     deserialization context, so that internal reference values are not lost to entries further down the stream.
        /// </summary>
        void SkipEntry();
