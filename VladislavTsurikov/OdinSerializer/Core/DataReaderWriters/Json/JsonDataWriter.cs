...
namespace OdinSerializer
{
    ...
    public class JsonDataWriter : BaseDataWriter
    {
        ...
        private readonly Dictionary<Type, int> seenTypes = new(16);
        private int bufferIndex;

        /// <summary>
        ///     Whether to enable an optimization that ensures any given type name is only written once into the json stream, and
        ///     thereafter kept track of by ID.
        /// </summary>
        ...
        public JsonDataWriter(Stream stream, SerializationContext context, bool formatAsReadable = true) : base(stream,
            context)
        {
        ...
        /// </summary>
        public void MarkJustStarted() => justStarted = true;
        ...
        public override void WriteBoolean(string name, bool value) => WriteEntry(name, value ? "true" : "false");
        ...
        /// <param name="name">The name of the value. If this is null, no name will be written.</param>
        /// <param name="value">The value to write.</param>
        public override void WriteByte(string name, byte value) => WriteUInt64(name, value);
        ...
        /// <param name="name">The name of the value. If this is null, no name will be written.</param>
        /// <param name="value">The value to write.</param>
        public override void WriteInt32(string name, int value) => WriteInt64(name, value);
        ...
        /// </summary>
        /// <param name="name">The name of the value. If this is null, no name will be written.</param>
        public override void WriteNull(string name) => WriteEntry(name, "null");
        ...
        public override void WriteInternalReference(string name, int id) => WriteEntry(name,
            JsonConfig.INTERNAL_REF_SIG + ":" + id.ToString("D", CultureInfo.InvariantCulture));
        ...
        /// <param name="name">The name of the value. If this is null, no name will be written.</param>
        /// <param name="value">The value to write.</param>
        public override void WriteSByte(string name, sbyte value) => WriteInt64(name, value);
        ...
        /// <param name="name">The name of the value. If this is null, no name will be written.</param>
        /// <param name="value">The value to write.</param>
        public override void WriteInt16(string name, short value) => WriteInt64(name, value);
        ...
        /// <param name="name">The name of the value. If this is null, no name will be written.</param>
        /// <param name="value">The value to write.</param>
        public override void WriteUInt32(string name, uint value) => WriteUInt64(name, value);
        ...
        public override void WriteExternalReference(string name, int index) =>
            WriteEntry(name,
                JsonConfig.EXTERNAL_INDEX_REF_SIG + ":" + index.ToString("D", CultureInfo.InvariantCulture));
        ...
        public override void WriteExternalReference(string name, Guid guid) => WriteEntry(name,
            JsonConfig.EXTERNAL_GUID_REF_SIG + ":" + guid.ToString("D", CultureInfo.InvariantCulture));
        ...
        /// <param name="name">The name of the value. If this is null, no name will be written.</param>
        /// <param name="value">The value to write.</param>
        public override void WriteUInt16(string name, ushort value) => WriteUInt64(name, value);
        ...
        private void WriteTypeEntry(Type type)
        {
            ...
            if (EnableTypeOptimization)
            {
                ...
                else
                {
                    ...
                    WriteString(JsonConfig.TYPE_SIG,
                        id + "|" + Context.Binder.BindToName(type, Context.Config.DebugContext));
                }
            }
            else
            {
