...
{
    /// <summary>
    ///     Contains various string constants used by the <see cref="JsonDataWriter" />, <see cref="JsonDataReader" /> and
    ///     <see cref="JsonTextReader" /> classes.
    /// </summary>
    public static class JsonConfig
    {
        ...
        /// <summary>
        ///     The beginning of the content of an external reference by string entry. This is an old entry using an invalid data
        ///     format where the ref string is dumped inline without escaping.
        /// </summary>
        public const string EXTERNAL_STRING_REF_SIG_OLD = "$strref";

        /// <summary>
        ///     The beginning of the content of an external reference by string entry. This is a new entry using the valid format
        ///     where the ref string is written as an escaped string.
        /// </summary>
