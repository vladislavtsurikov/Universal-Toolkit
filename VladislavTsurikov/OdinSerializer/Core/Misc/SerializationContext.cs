...
{
    /// <summary>
    ///     The context of a given serialization session. This class maintains all internal and external references during
    ///     serialization.
    /// </summary>
    /// <seealso cref="ICacheNotificationReceiver" />
    public sealed class SerializationContext : ICacheNotificationReceiver
    {
        private readonly Dictionary<object, int> internalReferenceIdMap =
            new(128, ReferenceEqualityComparer<object>.Default);
        ...
        void ICacheNotificationReceiver.OnFreed() => ResetToDefault();
        ...
        public bool TryGetInternalReferenceId(object reference, out int id) =>
            internalReferenceIdMap.TryGetValue(reference, out id);

        /// <summary>
        ///     Tries to register an internal reference. Returns <c>true</c> if the reference was registered, otherwise,
        ///     <c>false</c> when the reference has already been registered.
        /// </summary>
        /// <param name="reference">The reference to register.</param>
        /// <param name="id">The id of the registered reference.</param>
        /// <returns>
        ///     <c>true</c> if the reference was registered, otherwise, <c>false</c> when the reference has already been
        ///     registered.
        /// </returns>
        ...
        /// </summary>
        public void ResetInternalReferences() => internalReferenceIdMap.Clear();
