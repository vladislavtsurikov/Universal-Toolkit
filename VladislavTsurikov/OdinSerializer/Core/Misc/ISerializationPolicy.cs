...
namespace OdinSerializer
{
    ...
    ///     Usually, it governs the behaviour of the <see cref="FormatterEmitter" /> and <see cref="ReflectionFormatter{T}" />
    ///     classes.
    /// </summary>
    public interface ISerializationPolicy
    {
        ...
        ///     serialize can be recovered upon deserialization without knowing the policy ahead of time. This ID should preferably
        ///     be unique.
        /// </summary>
        /// <value>
