...
{
    /// <summary>
    ///     Indicates that an instance field or auto-property was previously serialized with a different name, so that values
    ///     serialized with the old name will be properly deserialized into this member.
    ...
    public class PreviouslySerializedAsAttribute : Attribute
    {
        ...
        public PreviouslySerializedAsAttribute(string name) => Name = name;
