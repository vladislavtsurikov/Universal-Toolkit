...
namespace OdinSerializer
{
    ...
    public class SerializationConfig
    {
        ...
        /// <summary>
        ///     <para>
        ///         Setting this member to true indicates that in the case where, when expecting to deserialize an instance of a
        ///         certain type,
        ///         but encountering an incompatible, uncastable type in the data being read, the serializer should attempt to
        ///         deserialize an
        ///         instance of the expected type using the stored, possibly invalid data.
        ///     </para>
        ///     <para>
        ///         This is equivalent to applying the <see cref="SerializationConfig.AllowDeserializeInvalidData" /> attribute,
        ///         except global
        ///         instead of specific to a single type. Note that if this member is set to false, individual types may still be
        ///         deserialized
        ///         with invalid data if they are decorated with the <see cref="SerializationConfig.AllowDeserializeInvalidData" />
        ///         attribute.
        ///     </para>
        /// </summary>
        ...
        /// </summary>
        public SerializationConfig() => ResetToDefault();

        /// <summary>
        ///     Gets or sets the serialization policy. This value is never null; if set to null, it will default to
        ///     <see cref="SerializationPolicies.Unity" />.
        /// </summary>
        /// <value>
        ...
        ///     <see cref="DebugContext" /> will be created upon the next get.
        /// </summary>
        /// <value>
        ///     The debug context.
        /// </value>
    ...
    public sealed class DebugContext
    {
        ...
        /// <summary>
        ///     Log a warning. Depending on the logging policy and error handling policy, this message may be suppressed or result
        ...
        public void LogWarning(string message)
        {
            if (errorHandlingPolicy == ErrorHandlingPolicy.ThrowOnWarningsAndErrors)
            {
                throw new SerializationAbortException(
                    "The following warning was logged during serialization or deserialization: " +
        ...
        /// <summary>
        ///     Log an error. Depending on the logging policy and error handling policy, this message may be suppressed or result
        ///     in an exception being thrown.
        /// </summary>
        public void LogError(string message)
        {
            ...
            {
                throw new SerializationAbortException(
                    "The following error was logged during serialization or deserialization: " +
                    (message ?? "EMPTY EXCEPTION MESSAGE"));
            }
        ...
        /// <summary>
        ///     Log an exception. Depending on the logging policy and error handling policy, this message may be suppressed or
        ...
        public void LogException(Exception exception)
        {
            ...
            {
                throw new SerializationAbortException(
                    "An exception of type " + exception.GetType().Name +
                    " occurred during serialization or deserialization.", exception);
            }
