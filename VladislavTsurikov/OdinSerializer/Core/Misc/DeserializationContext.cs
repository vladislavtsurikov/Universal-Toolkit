...
{
    /// <summary>
    ///     The context of a given deserialization session. This class maintains all internal and external references during
    ///     deserialization.
    /// </summary>
    /// <seealso cref="ICacheNotificationReceiver" />
    public sealed class DeserializationContext : ICacheNotificationReceiver
    {
        private readonly Dictionary<int, object> internalIdReferenceMap = new(128);
        ...
        void ICacheNotificationReceiver.OnFreed() => Reset();
        ...
        public void RegisterInternalReference(int id, object reference) => internalIdReferenceMap[id] = reference;
        ...
        public object GetExternalObject(int index)
        {
            ...
            Config.DebugContext.LogWarning("Failed to resolve external reference by index (" + index +
                                           "); the index resolver could not resolve the index. Reference lost.");
            return null;
        }
        ...
        public object GetExternalObject(Guid guid)
        {
            ...
            Config.DebugContext.LogWarning("Failed to resolve external reference by guid (" + guid +
                                           "); no guid resolver could resolve the guid. Reference lost.");
            return null;
        }
        ...
        public object GetExternalObject(string id)
        {
            ...
            Config.DebugContext.LogWarning("Failed to resolve external reference by string (" + id +
                                           "); no string resolver could resolve the string. Reference lost.");
            return null;
        }
