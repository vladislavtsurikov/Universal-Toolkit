...
#pragma warning disable 618
    ...
    /// <summary>
    ///     Serializes and deserializes a given type, and wraps serialization and deserialization with all the proper calls to
    ///     free formatters from tedious boilerplate.
    ///     <para />
    ///     Whenever serializing or deserializing anything, it is *strongly recommended* to use
    ///     <see cref="Serializer.Get{T}" /> to get a proper wrapping serializer for that type.
    ///     <para />
    ...
    ///     <see cref="ComplexTypeSerializer{T}" /> class.
    /// </summary>
    public abstract class Serializer
    {
        private static readonly Dictionary<Type, Type> PrimitiveReaderWriterTypes = new()
        {
        ...
        private static readonly Dictionary<Type, Serializer> Weak_ReaderWriterCache = new(FastTypeComparer.Instance);
        private static readonly Dictionary<Type, Serializer> Strong_ReaderWriterCache = new(FastTypeComparer.Instance);
#if UNITY_EDITOR
        ...
        /// <summary>
        ///     Gets a <see cref="Serializer" /> for the given value. If the value is null, it will be treated as a value of type
        ///     <see cref="object" />.
        /// </summary>
        ...
        public static Serializer<T> Get<T>() => (Serializer<T>)Get(typeof(T), false);
        ...
        public static Serializer Get(Type type) => Get(type, true);
        ...
        /// <summary>
        ///     Reads a value weakly, casting it into object. Use this method if you don't know what type you're going to be
        ///     working with at compile time.
        /// </summary>
        ...
        /// <summary>
        ///     Writes a weakly typed value. Use this method if you don't know what type you're going to be working with at compile
        ///     time.
        /// </summary>
        /// <param name="value">The value to write.</param>
        /// <param name="writer">The writer to use.</param>
        public void WriteValueWeak(object value, IDataWriter writer) => WriteValueWeak(null, value, writer);

        /// <summary>
        ///     Writes a weakly typed value with a given name. Use this method if you don't know what type you're going to be
        ///     working with at compile time.
        /// </summary>
        ...
        private static void LogAOTError(Type type, ExecutionEngineException ex)
        {
            Debug.LogError("No AOT serializer was pre-generated for the type '" + type.GetNiceFullName() + "'. " +
                           ...
                           "' is in the list of supported types after a scan. If it is not, please " +
    ...
    /// <summary>
    ///     Serializes and deserializes the type <see cref="T" />, and wraps serialization and deserialization with all the
    ...
    {
        /// <summary>
        ///     Reads a value of type <see cref="T" /> weakly, casting it into object. Use this method if you don't know what type
        ///     you're going to be working with at compile time.
        /// </summary>
        /// <param name="reader">The reader to use.</param>
        /// <returns>
        ///     The value which has been read.
        /// </returns>
        public override object ReadValueWeak(IDataReader reader) => ReadValue(reader);

        /// <summary>
        ///     Writes a weakly typed value of type <see cref="T" /> with a given name. Use this method if you don't know what type
        ///     you're going to be working with at compile time.
        /// </summary>
        /// <param name="name">The name of the value to write.</param>
        /// <param name="value">The value to write.</param>
        ...
        /// <param name="value">The value to write.</param>
        /// <param name="writer">The writer to use.</param>
        public void WriteValue(T value, IDataWriter writer) => WriteValue(null, value, writer);
        ...
        /// </summary>
        [Conditional("UNITY_EDITOR")]
        protected static void FireOnSerializedType() => FireOnSerializedType(typeof(T));
    }
}
