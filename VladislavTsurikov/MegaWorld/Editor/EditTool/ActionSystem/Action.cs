    ...
    public abstract class Action : ComponentStack.Runtime.Component
    {
        ...
        public void HandleButtons()
        {
            ...
            if(rayHit != null)
            {
                ...
                {
                    PrototypeGameObjectOverlap.OverlapSphere(rayHit.Point, editToolSettings.SphereSize / 2, (proto, go) =>
                    {
                        ...
                        if(DrawHandles.HandleButton(ToolWindow.EditorHash + prefabRoot.GetHashCode(), prefabRoot.transform.position, GetColorHandleButton(), new Color(1f, 1f, 0f, 0.7f)))
                        {
