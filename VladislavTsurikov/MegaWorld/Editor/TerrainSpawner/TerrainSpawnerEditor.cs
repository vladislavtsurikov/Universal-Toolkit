	...
	public sealed class TerrainSpawnerEditor : MonoBehaviourToolEditor
    {
		...
		public override void OnChangeGUIPrototype(Prototype proto)
		{
			...
			if (proto.GetType() == typeof(PrototypeTerrainDetail))
			{
				...
				_stamperTool.AutoRespawnController.StartAutoRespawn(_stamperTool.StamperControllerSettings.DelayAutoRespawn, new RespawnUnityTerrainDetail(prototypeTerrainDetail, _stamperTool));
				return;
			}
