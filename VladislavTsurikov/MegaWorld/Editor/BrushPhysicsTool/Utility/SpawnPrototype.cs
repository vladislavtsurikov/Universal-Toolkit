...
namespace VladislavTsurikov.MegaWorld.Editor.BrushPhysicsTool
{
    public static class SpawnPrototype
    {
        ...
        public static void SpawnTerrainObject(Group group, PrototypeTerrainObject proto, BoxArea boxArea, RayHit rayHit) 
        {
            ...
            BrushPhysicsToolSettings brushPhysicsToolSettings =
 (BrushPhysicsToolSettings)ToolsComponentStack.GetElement(typeof(BrushPhysicsTool), typeof(BrushPhysicsToolSettings));
                
            Instance instance =
 new Instance(rayHit.Point + new Vector3(0, brushPhysicsToolSettings.PositionOffsetY, 0), proto.Prefab.transform.lossyScale, proto.Prefab.transform.rotation);
