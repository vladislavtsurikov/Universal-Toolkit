...
namespace VladislavTsurikov.MegaWorld.Editor.Core.SelectionDatas.Group
{
    ...
    {
	    private readonly List<ClipboardGroup> _clipboardGroups = new List<ClipboardGroup>();
		...
		protected GenericMenu GroupMenu(IShowIcon icon)
        {
            ...
            {
	            ClipboardGroup clipboardGroup = ClipboardObject.GetCurrentClipboardObject(prototypeType, _toolType, _clipboardGroups);
