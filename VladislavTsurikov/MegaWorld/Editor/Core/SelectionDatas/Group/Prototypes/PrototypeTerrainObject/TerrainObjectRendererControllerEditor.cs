...
{
	[ResourceController(typeof(Runtime.Core.SelectionDatas.Group.Prototypes.PrototypeTerrainObject.PrototypeTerrainObject))]
    public class TerrainObjectRendererControllerEditor : ResourceControllerEditor
    {
        ...
        {
	        foreach (RendererStack.Runtime.TerrainObjectRenderer.PrototypeTerrainObject prototype in TerrainObjectRenderer.Instance.SelectionData.PrototypeList)
	        {
