...
namespace VladislavTsurikov.MegaWorld.Editor.Core.SelectionDatas.ResourceController 
{
    public static class ResourcesControllerEditor
    {
        ...
        private static readonly ResourceControllerEditorStack _resourceControllerEditorStack = new ResourceControllerEditorStack();

	    static ResourcesControllerEditor()
        {
	        _resourceControllerEditorStack.Setup();
        }
        ...
        public static void DrawResourceController(SelectionData selectionData, bool drawFoldout = true)
        {
	        if(selectionData.SelectedData.HasOneSelectedGroup())
	        {
		        ...
		        ResourceControllerEditor resourceControllerEditor = _resourceControllerEditorStack.GetResourceControllerEditor(group.PrototypeType);
