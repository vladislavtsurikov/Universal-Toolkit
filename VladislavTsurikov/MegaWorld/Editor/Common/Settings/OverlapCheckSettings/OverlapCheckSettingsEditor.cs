...
namespace VladislavTsurikov.MegaWorld.Editor.Common.Settings.OverlapCheckSettings
{
    ...
    public class OverlapCheckSettingsEditor : IMGUIElementEditor
    {
        ...
        {
	        _settings.OverlapShapeEnum = (OverlapShapeEnum)CustomEditorGUILayout.EnumPopup(OverlapShape, _settings.OverlapShapeEnum);
	        ...
	        switch (_settings.OverlapShapeEnum)
	        {
		        case OverlapShapeEnum.OBB:
		        {
			        ...
			        obbCheck.BoundsType = (BoundsCheckType)CustomEditorGUILayout.EnumPopup(BoundsType, obbCheck.BoundsType);

			        if(obbCheck.BoundsType == BoundsCheckType.Custom)
			        {
				        obbCheck.UniformBoundsSize = CustomEditorGUILayout.Toggle(UniformBoundsSize, obbCheck.UniformBoundsSize);
				        ...
				        obbCheck.MultiplyBoundsSize = CustomEditorGUILayout.Slider(MultiplyBoundsSize, obbCheck.MultiplyBoundsSize, 0, 5);
			        }
