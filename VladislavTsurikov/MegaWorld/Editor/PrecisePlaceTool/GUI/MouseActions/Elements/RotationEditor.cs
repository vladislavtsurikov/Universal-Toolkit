...
namespace VladislavTsurikov.MegaWorld.Editor.PrecisePlaceTool.GUI.MouseActions.Elements
{
    ...
    public class RotationEditor : IMGUIElementEditor
    {
        ...
        {
            _settings.MouseRotationSettings.MouseSensitivity = CustomEditorGUILayout.Slider(new GUIContent("Mouse Sensitivity"), _settings.MouseRotationSettings.MouseSensitivity, MouseSensitivitySettings.MinMouseSensitivity, MouseSensitivitySettings.MaxMouseSensitivity);
            _settings.WayRotateY = (WayRotateY)CustomEditorGUILayout.EnumPopup(new GUIContent("Way Rotate Y"), _settings.WayRotateY);
            if(_settings.WayRotateY == WayRotateY.Offset)
            {
                GlobalCommonComponentSingleton<TransformSpaceSettings>.Instance.TransformSpace = (TransformSpace)CustomEditorGUILayout.EnumPopup(new GUIContent("Transform Space"), 
