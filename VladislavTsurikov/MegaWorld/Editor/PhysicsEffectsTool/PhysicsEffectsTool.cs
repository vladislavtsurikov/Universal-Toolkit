...
namespace VladislavTsurikov.MegaWorld.Editor.PhysicsEffectsTool
{
    ...
    public class PhysicsEffectsTool : ToolWindow
    {
        ...
        {
            _physicsEffectsToolSettings = (PhysicsEffectsToolSettings)ToolsComponentStack.GetElement(typeof(PhysicsEffectsTool), typeof(PhysicsEffectsToolSettings));
        ...
        {
            _physicsEffectsToolSettings.List.SelectedElement?.DoEffect(_mouseMove.Raycast);
        }

        private void OnMouseDrag(Vector3 dragPoint)
        {
            RayHit rayHit = ColliderUtility.Raycast(RayUtility.GetRayDown(dragPoint), GlobalCommonComponentSingleton<LayerSettings>.Instance.PaintLayers);
        ...
        {
            _physicsEffectsToolSettings.List.SelectedElement?.OnRepaint(_mouseMove.Raycast);
        }
    }
}
#endif