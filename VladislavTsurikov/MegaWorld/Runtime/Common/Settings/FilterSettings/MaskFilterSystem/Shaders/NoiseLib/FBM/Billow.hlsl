...
#include "Assets/VladislavTsurikov/MegaWorld/CommonScripts/Scripts/Settings/MaskFilters/Shaders/NoiseLib/Implementation/BillowImpl.hlsl"
#include "Assets/VladislavTsurikov/MegaWorld/CommonScripts/Scripts/Settings/MaskFilters/Shaders/NoiseLib/NoiseCommon.hlsl"
...
float noise_FbmBillow(float3 pos, FbmFractalInput fractalInput)
{
    ...
    for (float i = 0; i < warpIterations; ++i)
    {
        float3 q = float3(noise_FbmBillow_Raw(pos.xyz, fractalInput),
                          ...
                          noise_FbmBillow_Raw(
                              pos.xyz + float3(fractalInput.warpOffsets.x, fractalInput.warpOffsets.y, 0),
                              fractalInput));
        prev = pos;
        pos = pos + fractalInput.warpStrength * q;
    }
