...
namespace VladislavTsurikov.MegaWorld.Runtime.Common.Settings.FilterSettings.MaskFilterSystem
{
	public class TerrainPainterRenderHelper
	{
        ...
        public TerrainPainterRenderHelper(BoxArea boxArea)
		{
            ...
            _brushTransform = TerrainPaintUtility.CalculateBrushTransform(_terrainUnderCursor, currUV, boxArea.BoxSize, boxArea.Rotation);
...
#region Rendering
		...
		{
			TerrainPaintUtilityEditor.DrawBrushPreview(paintContext, previewTexture, BoxArea.Mask, _brushTransform, material, pass);
		}
#else
