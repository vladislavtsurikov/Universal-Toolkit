...
using VladislavTsurikov.MegaWorld.Runtime.Common.Settings.FilterSettings.MaskFilterSystem.Noise.NoiseTypes;
...
namespace VladislavTsurikov.MegaWorld.Runtime.Common.Settings.FilterSettings.MaskFilterSystem.Noise
{
    ...
    public class NoiseSettings //: ScriptableObject
    {
        ...
        public NoiseTransformSettings TransformSettings = new();
        ...
        public NoiseDomainSettings DomainSettings = new();
        ...
        public Matrix4x4 trs
        {
            get
            {
                ...
                var trs = Matrix4x4.TRS(TransformSettings.Translation,
