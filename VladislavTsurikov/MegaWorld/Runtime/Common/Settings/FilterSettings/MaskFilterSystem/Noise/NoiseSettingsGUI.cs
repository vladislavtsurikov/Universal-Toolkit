...
namespace VladislavTsurikov.MegaWorld.Runtime.Common.Settings.FilterSettings.MaskFilterSystem.Noise
{
    public class NoiseSettingsGUI
    {
        ...
        {
            MNoiseSettings.ShowNoiseTransformSettings = EditorGUI.Foldout(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), MNoiseSettings.ShowNoiseTransformSettings, new GUIContent("TransformSettings"));
            if (MNoiseSettings.ShowNoiseTransformSettings)
            {
                ...
                rect.y += EditorGUIUtility.singleLineHeight;
                MNoiseSettings.TransformSettings.Translation = EditorGUI.Vector3Field(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), new GUIContent(""), MNoiseSettings.TransformSettings.Translation);
                rect.y += EditorGUIUtility.singleLineHeight;
                EditorGUI.LabelField(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), new GUIContent("Rotation"));
                rect.y += EditorGUIUtility.singleLineHeight;
                MNoiseSettings.TransformSettings.Rotation = EditorGUI.Vector3Field(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), new GUIContent(""), MNoiseSettings.TransformSettings.Rotation);
                rect.y += EditorGUIUtility.singleLineHeight;
                EditorGUI.LabelField(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), new GUIContent("Scale"));
                rect.y += EditorGUIUtility.singleLineHeight;
                MNoiseSettings.TransformSettings.Scale = EditorGUI.Vector3Field(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), new GUIContent(""), MNoiseSettings.TransformSettings.Scale);
                EditorGUI.indentLevel--;
            }
        }
        ...
        {
            MNoiseSettings.ShowNoiseTypeSettings = EditorGUI.Foldout(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), MNoiseSettings.ShowNoiseTypeSettings, new GUIContent("DomainSettings"));
            if (MNoiseSettings.ShowNoiseTypeSettings)
            {
                EditorGUI.indentLevel++;
                rect.y += EditorGUIUtility.singleLineHeight;
                MNoiseSettings.DomainSettings.NoiseTypeName = NoiseLib.NoiseTypePopup(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), new GUIContent("Type"), MNoiseSettings.DomainSettings.NoiseTypeName);
                rect.y += EditorGUIUtility.singleLineHeight;
                IFractalType fractalType = NoiseLib.GetFractalTypeInstance(MNoiseSettings.DomainSettings.FractalTypeName);
                MNoiseSettings.DomainSettings.FractalTypeParams = fractalType?.DoGUI(rect, MNoiseSettings.DomainSettings.FractalTypeParams);
                EditorGUI.indentLevel--;
            }
        }
        ...
        {
            MNoiseSettings.ShowNoisePreviewTexture = EditorGUI.Foldout(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), MNoiseSettings.ShowNoisePreviewTexture, new GUIContent("PreviewTexture"));
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent Export = EditorGUIUtility.TrTextContent("Export", "Open a window providing options for exporting Noise to Textures");
            public static readonly GUIContent InfoIcon = new GUIContent("", EditorGUIUtility.FindTexture("console.infoicon"),
