namespace VladislavTsurikov.MegaWorld.Runtime.Common.Settings.FilterSettings.MaskFilterSystem.Noise.NoiseTypes
{
    ...
    public class BillowNoise : NoiseType<BillowNoise>
    {
        ...
        {
            name = "Billow",
            outputDir = Path.Path + "/CommonScripts/Scripts/Settings/MaskFilters/Shaders/NoiseLib/",
            sourcePath = Path.Path + "/CommonScripts/Scripts/Settings/MaskFilters/Shaders/NoiseLib/Implementation/BillowImpl.hlsl",
