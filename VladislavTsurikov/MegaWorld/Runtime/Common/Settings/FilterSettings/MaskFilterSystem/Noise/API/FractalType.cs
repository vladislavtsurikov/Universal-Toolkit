...
namespace VladislavTsurikov.MegaWorld.Runtime.Common.Settings.FilterSettings.MaskFilterSystem.Noise.API
{
    ...
    public interface IFractalType
    {
        ...
        ///     changes from user interaction with the GUI
        /// </returns>
        string DoGUI(Rect rect, string serializedString);
    ...
    public abstract class FractalType<T> : ScriptableSingleton<T>, IFractalType where T : FractalType<T>
    {
        ...
        /// </summary>
        public virtual string GetDefaultSerializedString() => null;
        ...
        /// <summary>
        ///     When overidden, renders the GUI for the FractalType implementation using the data provided by the serialized
        ///     string.
        /// </summary>
        /// <param name="serializedString"> A string for the serialized data used by the FractalType implementation </param>
        /// <returns>
        ...
        ///     changes from user interaction with the GUI
        /// </returns>
        public virtual string DoGUI(string serializedString) => null;
        ...
        ///     changes from user interaction with the GUI
        /// </returns>
        public virtual string DoGUI(Rect rect, string serializedString) => null;
        ...
        /// </param>
        /// <returns> The string representation of the provided target object </returns>
        public virtual string ToSerializedString(object target) => null;
        ...
        /// </param>
        /// <returns> An object deserialized from the provided string </returns>
        public virtual object FromSerializedString(string serializedString) => null;
    }
}
