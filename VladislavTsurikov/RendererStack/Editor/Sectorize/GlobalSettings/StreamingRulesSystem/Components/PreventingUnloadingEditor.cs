...
namespace VladislavTsurikov.RendererStack.Editor.Sectorize.GlobalSettings.StreamingRulesSystem
{
    ...
    public class PreventingUnloadingEditor : ReorderableListComponentEditor
    {
        ...
        {
            _preventingUnloading = (PreventingUnloading)Target;
        }
        
        public override void OnGUI(Rect rect, int index)
        {
            _preventingUnloading.MaxDistance = CustomEditorGUI.FloatField(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), _maxDistance, _preventingUnloading.MaxDistance);
        ...
        private GUIContent _maxDistance = new GUIContent("Max Distance");
    }
}
#endif