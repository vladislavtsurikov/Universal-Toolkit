...
namespace VladislavTsurikov.RendererStack.Editor.TerrainObjectRenderer.GlobalSettings.ExtensionSystem.UnityTerrainTreeConverter
{
    ...
    public class UnityTerrainTreeConverterEditor : ReorderableListComponentEditor
    {
        ...
        {
	        if(CustomEditorGUI.ClickButton(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), "Remove All Unity Terrain Prototypes From Terrains", ButtonStyle.Remove))
	        {
	        ...
	        if(CustomEditorGUI.ClickButton(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), "Unspawn Unity Terrain Tree", ButtonStyle.Remove))
	        {
		        if (EditorUtility.DisplayDialog("WARNING!",
	        ...
	        if(CustomEditorGUI.ClickButton(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), "Convert All Unity Terrain Tree To Terrain Object Renderer"))
	        {
	        ...
	        EditorGUI.HelpBox(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), "Only added prefabs in Renderer are converted when using this button.", MessageType.Info);    
	        
	        rect.y += CustomEditorGUI.SingleLineHeight;
            
	        if(CustomEditorGUI.ClickButton(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),"Convert Unity Terrain Tree To Terrain Object Renderer"))
	        {
	        ...
	        if(CustomEditorGUI.ClickButton(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight), "Convert Terrain Object Renderer To Unity Terrain Tree"))
	        {
