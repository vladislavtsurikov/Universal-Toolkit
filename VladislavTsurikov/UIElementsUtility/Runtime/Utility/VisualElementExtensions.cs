...
namespace VladislavTsurikov.UIElementsUtility.Runtime.Utility
{
    public static class VisualElementExtensions
    {
        ...
        public static T AddPaddingSpace<T>(this T target, float left, float top, float right, float bottom) where T : VisualElement =>
            target.AddChild(new VisualElement()).SetName("PaddingSpace").SetStylePadding(left, top, right, bottom);
