...
namespace VladislavTsurikov.UIElementsUtility.Runtime.Utility
{
    public static class VisualElementExtensions
    {
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static bool HasParent<T>(this T target) where T : VisualElement => target.parent != null;
        ...
        ///     <para />
        ///     enabledSelf && enabledInHierarchy
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        ...
        public static TO ReplaceWith<T, TO>(this T target, TO other) where T : VisualElement where TO : VisualElement
        {
            ...
            var targetIndexInParentHierarchy =
                parent.IndexOf(target); //get the 'child index' of the target inside the parent's hierarchy
            target.RemoveFromHierarchy(); //remove the target from its parent hierarchy
            parent.Insert(targetIndexInParentHierarchy,
                other); //insert the element back to the parent at the initial target's index
        ...
        /// <param name="flexGrow">
        ///     Set how much the item will grow relative to the rest of the flexible items inside the same
        ///     container - style.flexGrow
        /// </param>
        public static T AddTemplateContainer<T>(this T target, string layoutPath, float flexGrow = 1)
            where T : VisualElement
        {
#if UNITY_EDITOR
            TemplateContainer templateContainer = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(layoutPath).CloneTree()
                .SetStyleFlexGrow(flexGrow);
        ...
        public static T AddPaddingSpace<T>(this T target, float left, float top, float right, float bottom)
            where T : VisualElement =>
            target.AddChild(new VisualElement()).SetName("PaddingSpace")
                .SetStylePadding(left, top, right, bottom);
        ...
        /// <summary>
        ///     [Editor] Add the 'Dark' or 'Light' class name to the target element, depending on the current active Editor
        ///     Theme, and get back the reference to the target
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static T AddCurrentThemeClass<T>(this T target) where T : VisualElement
        {
#if UNITY_EDITOR
            return target.AddClass(EditorGUIUtility.isProSkin ? "Dark" : "Light");
#else
            return target;
#endif
        }
        ...
        {
#if UNITY_EDITOR
            target.AddStyle(AssetDatabase.LoadAssetAtPath<StyleSheet>(styleSheetPath));
#endif
            return target;
        }
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static string GetName<T>(this T target) where T : VisualElement => target.name;
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static string GetTooltip<T>(this T target) where T : VisualElement => target.tooltip;
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static PickingMode GetPickingMode<T>(this T target) where T : VisualElement => target.pickingMode;
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static Align GetStyleAlignSelf<T>(this T target) where T : VisualElement => target.style.alignSelf.value;
        ...
        /// <summary>
        ///     Set the alignment of the whole area of children on the cross axis if they span over multiple lines in this
        ///     container
        ///     <para />
        ///     style.alignContent
        /// </summary>
        ...
        /// <summary>
        ///     Get the alignment of the whole area of children on the cross axis if they span over multiple lines in this
        ///     container
        ///     <para />
        ///     style.alignContent
        /// </summary>
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static float GetStyleFlexGrow<T>(this T target) where T : VisualElement => target.style.flexGrow.value;
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static Wrap GetStyleFlexWrap<T>(this T target) where T : VisualElement => target.style.flexWrap.value;
        ...
        public static T SetStyleBorderColor<T>(this T target, Color left, Color top, Color right, Color bottom)
            where T : VisualElement
        {
        ...
        public static T SetStyleBorderWidth<T>(this T target, float left, float top, float right, float bottom)
            where T : VisualElement
        {
        ...
        public static T SetStyleBorderRadius<T>(this T target, float topLeft, float topRight, float bottomRight,
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static float GetStyleOpacity<T>(this T target) where T : VisualElement => target.style.opacity.value;
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static float GetStyleHeight<T>(this T target) where T : VisualElement => target.style.height.value.value;

        /// <summary>
        ///     Set the fixed MinHeight, Height and MaxHright of an element for the layout
        ///     <para />
        ///     style.minHeight
        ///     <para />
        ///     style.height
        ...
        public static T SetStyleHeight<T>(this T target, float minHeight, float height, float maxHeight)
            where T : VisualElement =>
            target.SetStyleMinHeight(minHeight)
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static float GetStyleWidth<T>(this T target) where T : VisualElement => target.style.width.value.value;
        ...
        /// <returns></returns>
        public static T SetStyleWidth<T>(this T target, float minWidth, float width, float maxWidth)
            where T : VisualElement =>
            target.SetStyleMinWidth(minWidth)
                .SetStyleWidth(width)
        ...
        /// <summary>
        ///     Set the values for the minimum width and minimum height for an element, when it is flexible or measures its own
        ///     size
        ///     <para />
        ///     style.minWidth
        ///     <para />
        ...
        /// <summary>
        ///     Set the same values for minimum width and minimum height for an element, when it is flexible or measures its own
        ///     size
        ///     <para />
        ///     style.minWidth
        ///     <para />
        ...
        /// <summary>
        ///     Set the values for the maximum width and maximum height for an element, when it is flexible or measures its own
        ///     size
        ///     <para />
        ///     style.maxWidth
        ///     <para />
        ...
        /// <summary>
        ///     Set the same values for the maximum width and maximum height for an element, when it is flexible or measures its
        ///     own size
        ///     <para />
        ///     style.maxWidth
        ///     <para />
        ...
        /// <summary>
        ///     Set the same values for maximum width and maximum height for an element, when it is flexible or measures its own
        ///     size
        ///     <para />
        ///     style.maxWidth
        ///     <para />
        ...
        {
#if UNITY_EDITOR
            target.SetStyleBackgroundImage(AssetDatabase.LoadAssetAtPath<Texture2D>(texturePath));
#endif
            return target;
        }
        ...
        {
#if UNITY_EDITOR
            return AssetDatabase.GetAssetPath(target.style.backgroundImage.value.texture);
#else
        ...
        /// <param name="target"> Target VisualElement </param>
        public static StyleKeyword GetStyleBackgroundImageTintColorStyleKeyword<T>(this T target)
            where T : VisualElement =>
        ...
        public static T SetStyleUnitySlice<T>(this T target, int left, int top, int right, int bottom)
            where T : VisualElement
        {
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static Color GetStyleColor<T>(this T target) where T : VisualElement => target.resolvedStyle.color;
        ...
        public static T SetStyleUnityFontStyle<T>(this T target, FontStyle value) where T : VisualElement
        {
        ...
        public static Font GetStyleUnityFont<T>(this T target) where T : VisualElement => target.style.unityFont.value;
        ...
        /// <param name="target"> Target VisualElement </param>
        public static T ClearMargins<T>(this T target) where T : VisualElement => target.SetStyleMargins(0);
        ...
        public static T SetStyleMargins<T>(this T target, float left, float top, float right, float bottom)
            where T : VisualElement
        {
        ...
        /// <param name="target"> Target VisualElement </param>
        public static T ClearPaddings<T>(this T target) where T : VisualElement => target.SetStylePadding(0f);
        ...
        public static T SetStylePadding<T>(this T target, float left, float top, float right, float bottom)
            where T : VisualElement
        {
        ...
        public static T ResizeToWidth<T>(this T target, float referenceWidth) where T : VisualElement
        {
            ...
            var ratio = referenceWidth / width;
        ...
        public static T ResizeToHeight<T>(this T target, float referenceHeight) where T : VisualElement
        {
            var width = target.resolvedStyle.width;
            var height = target.resolvedStyle.height;
            var ratio = referenceHeight / height;
        ...
        /// <param name="referenceWidth"> Target width </param>
        public static T ResizeToTextureWidth<T>(this T target, Texture texture, float referenceWidth)
            where T : VisualElement
        {
            if (texture == null)
            {
        ...
        /// ///
        /// <param name="referenceHeight"> Target height </param>
        public static T ResizeToTextureHeight<T>(this T target, Texture texture, float referenceHeight)
            where T : VisualElement
        {
            if (texture == null)
            {
        ...
        /// <summary>
        ///     Resize the element to the given texture size and apply a given ratio (to make it bigger or smaller
        ///     proportionately)
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        /// <param name="texture"> Target Texture </param>
        ...
        public static T ResizeToTextureSize<T>(this T target, Texture texture, float ratio = 1) where T : VisualElement
        {
            ...
            var width = hasTexture ? texture.width : 0f;
            var height = hasTexture ? texture.height : 0f;
        ...
        /// <summary>
        ///     Resize the element to its own background image texture size and apply a given ratio (to make it bigger or
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static T Show<T>(this T target) where T : VisualElement => target.SetStyleDisplay(DisplayStyle.Flex);
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static T Hide<T>(this T target) where T : VisualElement => target.SetStyleDisplay(DisplayStyle.None);
        ...
        /// <param name="target"> Target VisualElement </param>
        public static T ClearDistances<T>(this T target) where T : VisualElement => target.SetStyleDistance(0, 0, 0, 0);
        ...
        public static T SetStyleDistance<T>(this T target, float left, float top, float right, float bottom)
            where T : VisualElement
        {
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static float GetStyleLeft<T>(this T target) where T : VisualElement => target.style.left.value.value;
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static float GetStyleTop<T>(this T target) where T : VisualElement => target.style.top.value.value;
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static float GetStyleRight<T>(this T target) where T : VisualElement => target.style.right.value.value;
        ...
        /// </summary>
        /// <param name="target"> Target VisualElement </param>
        public static float GetStyleBottom<T>(this T target) where T : VisualElement => target.style.bottom.value.value;
