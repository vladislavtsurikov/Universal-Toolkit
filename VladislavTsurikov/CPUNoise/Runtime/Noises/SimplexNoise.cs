...
namespace VladislavTsurikov.CPUNoise.Runtime
{
    ...
    /// </summary>
    public class SimplexNoiseCPU : NoiseCPU
    {
        /// <summary>
        ///     Create a simplex noise object.
        /// </summary>
        public SimplexNoiseCPU(int seed, float frequency, float amplitude = 1.0f)
        {
            Frequency = frequency;
            Amplitude = amplitude;
            Offset = Vector3.zero;
        ...
        public override float Sample1D(float x)
        {
            ...
            var t0 = 1.0f - x0 * x0;
            t0 *= t0;
            var n0 = t0 * t0 * Grad(Perm[i0], x0);

            var t1 = 1.0f - x1 * x1;
            t1 *= t1;
            var n1 = t1 * t1 * Grad(Perm[i1], x1);
