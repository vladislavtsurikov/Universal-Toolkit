...
namespace VladislavTsurikov.UnityTimer.Runtime
{
    public class Timer
    {
        ...
        /// <param name="onUpdate">
        ///     An action that should fire each time the timer is updated. Takes the amount
        ///     of time passed in seconds since the start of the timer's current loop.
        /// </param>
        /// <param name="isLooped">Whether the timer should repeat after executing.</param>
        /// <param name="useRealTime">
        ///     Whether the timer uses real-time(i.e. not affected by pauses,
        ///     slow/fast motion) or game-time(will be affected by pauses and slow/fast-motion).
        /// </param>
        /// <param name="autoDestroyOwner">
        ///     An object to attach this timer to. After the object is destroyed,
        ...
        ///     after the parent has been destroyed.
        /// </param>
        ...
        /// </summary>
        /// <returns>
        ///     The number of seconds that have elapsed since the start of this timer's current cycle, i.e.
        ...
        /// </summary>
        /// <returns>
        ///     The number of seconds that remain to be elapsed until the timer is completed. A timer
