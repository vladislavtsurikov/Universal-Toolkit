...
namespace VladislavTsurikov.ColorUtility.Runtime
{
    public static class ColorExtensions
    {
        public static Color From256(this Color target, int r, int g, int b, float a = 1f) =>
            new(r / 256f, g / 256f, b / 256f, a);

        /// <summary> Get the maximum value of this color's RGB values </summary>
        public static float MaxRGB(this Color target) => Mathf.Max(target.r, target.g, target.b);

        /// <summary> Get the minimum value of this color's RGB values </summary>
        public static float MinRGB(this Color target) => Mathf.Min(target.r, target.g, target.b);

        /// <summary>
        ///     Luminosity (also called brightness, lightness or luminance) stands for the intensity of the energy output of a
        ///     visible light source.
        ///     <para />
        ///     It basically tells how light a colour is and is measured on the following scale: L = [0, 1]
        ///     <para />
        ...
        ///     <para />
        ///     As saturation increases, colours appear more pure. As saturation decreases, colours appear more washed-out.
        ///     <para />
        ///     It is measured on the following scale: S = [0, 1]
        /// </summary>
        ...
        public static float Alpha(this Color target) => target.a;
        ...
        public static Color WithAlpha(this Color target, float value) =>
            new(target.r, target.g, target.b, Mathf.Clamp01(value));
        ...
        ///     <para />
        ///     A tint is produced by "lightning" a hue or "adding white"
        /// </summary>
        /// <param name="target"> Target Color </param>
        ...
        ///     <para />
        ///     Layering the target color with the other color
        /// </summary>
        /// <param name="target"> Target Color </param>
        /// <param name="other"> Other Color </param>
        public static Color MixedWithColor(this Color target, Color other) =>
            new(target.r + (other.r - target.r) * other.a,
                target.g + (other.g - target.g) * other.a,
                target.b + (other.b - target.b) * other.a);


        public static HSL ToHSL(this Color target) => ColorUtils.COLORtoHSL(target);

        public static HSV ToHSV(this Color target) => ColorUtils.COLORtoHSV(target);

        public static RGB ToRGB(this Color target) => ColorUtils.COLORtoRGB(target);
        ...
        /// <param name="target"> Target Color </param>
        /// <param name="factorize">
        ///     TRUE returns a value between 0 and 360
        ///     <para />
        ///     FALSE returns a value between 0 and 1
        /// </param>
        ...
        /// <param name="target"> Target Color </param>
        public static float GetHSLSaturation(this Color target) => target.ToHSL().s;
        ...
        /// <param name="target"> Target Color </param>
        public static float GetHSLLightness(this Color target) => target.ToHSL().l;
        ...
        ///     <para />
        ///     50% means an unaltered Hue = 0.5f
        ///     <para />
        ///     over 50% means the Hue is lighter (tint) = over 0.5f
        ///     <para />
        ///     below 50% means the Hue is darker (shade) = below 0.5f
        /// </summary>
        /// <param name="target"> Target Color </param>
        ...
        /// <param name="target"> Target Color </param>
        public static float GetHSVSaturation(this Color target) => target.ToHSV().s;

        /// <summary>
        ///     Set HSV saturation by converting to HSV, setting the new value, and returning the new Color
        ///     <para />
        ///     To shade: increase the Saturation
        ///     <para />
        ///     To tint: lower the Saturation
        /// </summary>
        /// <param name="target"> Target Color </param>
        ...
        /// <param name="target"> Target Color </param>
        public static float GetHSVValue(this Color target) => target.ToHSV().v;

        /// <summary>
        ///     Set HSV value (brightness) by converting to HSV, setting the new value, and returning the new Color
        ///     <para />
        ///     To shade: lower the Value (brightness)
        ///     <para />
        ///     To tint: increase the Value (brightness)
        /// </summary>
        /// <param name="target"> Target Color </param>
        /// <param name="value">
