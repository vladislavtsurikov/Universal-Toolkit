...
{ 
    ...
    public class SpawnPrefabsEditor : ReorderableListComponentEditor
    {
        ...
        public override void OnEnable()
        {
            ...
            _reorderableList = new ReorderableList(_spawnPrefabs.GameObjects, typeof(GameObject), true, false, true, true );
        ...
        {
            _spawnPrefabs.GameObjects[index] = (GameObject)CustomEditorGUI.ObjectField(new Rect(totalRect.x, totalRect.y, totalRect.width, EditorGUIUtility.singleLineHeight),
