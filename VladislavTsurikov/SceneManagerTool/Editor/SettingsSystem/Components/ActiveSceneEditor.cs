...
namespace VladislavTsurikov.SceneManagerTool.Editor.SettingsSystem
{
    ...
    public class ActiveSceneEditor : ReorderableListComponentEditor
    {
        ...
        {
            _activeScene = (ActiveScene)Target;
        }
        
        public override void OnGUI(Rect rect, int index)
        {
            _activeScene.SceneReference.SceneAsset = (SceneAsset)CustomEditorGUI.ObjectField(new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),null, 
