...
namespace VladislavTsurikov.ShaderVariantCollection.Editor
{
    ...
    {        
        ...
        {
            UnityEngine.ShaderVariantCollection shaderVariantCollection = Resources.Load<UnityEngine.ShaderVariantCollection>(CommonPath.CombinePath(CommonPath.Publisher, CommonPath.ShaderVariantCollectionName)); 
